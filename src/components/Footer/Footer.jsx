  ...
  return (
    <div>
      <footer className="footer items-center p-4 bg-neutral text-neutral-content">
        <aside className="items-center w-full justify-center lg:justify-start grid-flow-col">
        ...
        <nav className="grid-flow-col w-full flex justify-center lg:justify-end gap-4 md:place-self-center md:justify-self-end">
